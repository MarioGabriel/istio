...
pushd "$SCRIPTDIR/reviews"
  ...
  pushd reviews-wlpcfg
    ...
    #with ratings blue stars
    docker build -t "istio/examples-bookinfo-reviews-v4:${VERSION}" -t istio/examples-bookinfo-reviews-v3:latest --build-arg service_version=v4 \
     --build-arg enable_ratings=true --build-arg star_color=blue .
  popd
popd
